...
{
    [TestClass]
    public class PaymentMethodDirectDebitTest : TestBase
    {
        private InvoiceProviders.PaymentMethodDirectDebit _InvoiceProvider = new InvoiceProviders.PaymentMethodDirectDebit();
