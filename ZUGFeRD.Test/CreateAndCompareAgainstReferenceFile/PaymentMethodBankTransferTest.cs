...
{
    [TestClass]
    public class PaymentMethodBankTransferTest : TestBase
    {
        private InvoiceProviders.PaymentMethodBankTransfer _InvoiceProvider = new InvoiceProviders.PaymentMethodBankTransfer();
