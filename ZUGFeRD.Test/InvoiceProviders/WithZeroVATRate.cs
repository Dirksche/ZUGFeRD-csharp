...
namespace s2industries.ZUGFeRD.Test.InvoiceProviders
{
    ...
    /// </summary>
    internal class WithZeroVATRate : InvoiceProviderBase
    {
        /// <summary>
        ...
        internal override InvoiceDescriptor CreateInvoice()
        {
            ...
            desc.AddTradeLineItem(name: "Umsatzsteuerbefreite Rechnungsposition",
                                  unitCode: QuantityCodes.H87,
                                  sellerAssignedID: "04169807",
                                  id: new GlobalID(GlobalIDSchemeIdentifiers.EAN, "4001234567890"),
                                  grossUnitPrice: 28.99m,
                                  netUnitPrice: 28.99m,
                                  billedQuantity: 2,
                                  lineTotalAmount: 57.98m,
                                  taxType: TaxTypes.VAT,
            ...
            desc.AddApplicableTradeTax(basisAmount: 57.98m,
                                       percent: 0m,
                                       taxAmount: 0m,
            ...
            desc.SetTotals(lineTotalAmount: 530.98m,
                           taxBasisAmount: 530.98m,
                           taxTotalAmount: 56.87m,
                           grandTotalAmount: 587.85m,
                           duePayableAmount: 587.85m
                          );
